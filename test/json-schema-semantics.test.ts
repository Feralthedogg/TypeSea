...
describe("JSON Schema semantic export", () => {
    ...
    test("matches TypeSea guards over JSON-compatible values", () => {
        const guards: readonly Guard<unknown, Presence>[] = [
            ...
            t.string.min(5).min(1).max(10).max(7),
            t.string.regex(/^[ab]+$/, "ab_word"),
            t.string.regex(/^a+$/, "a_word").regex(/^.{2,}$/, "two_chars"),
            t.number,
            t.number.int().gte(-2).lte(4),
            t.number.gte(3).gte(-1).lte(9).lte(5),
            t.boolean,
            t.literal("alpha"),
            t.literal(2),
            t.nullable(t.string),
...
/**
 * @brief Evaluate json schema matching.
 * @details Test helpers pin observable behavior so engine rewrites keep the same external result.
 */
...
/**
 * @brief Evaluate type name matching.
 * @details Test helpers pin observable behavior so engine rewrites keep the same external result.
 */
...
/**
 * @brief Evaluate string keywords matching.
 * @details Test helpers pin observable behavior so engine rewrites keep the same external result.
 */
...
/**
 * @brief Evaluate number keywords matching.
 * @details Test helpers pin observable behavior so engine rewrites keep the same external result.
 */
...
/**
 * @brief Evaluate array keywords matching.
 * @details Test helpers pin observable behavior so engine rewrites keep the same external result.
 */
...
/**
 * @brief Evaluate object keywords matching.
 * @details Test helpers pin observable behavior so engine rewrites keep the same external result.
 */
...
/**
 * @brief Evaluate additional properties matching.
 * @details Test helpers pin observable behavior so engine rewrites keep the same external result.
 */
...
/**
 * @brief Evaluate disjunction matching.
 * @details Test helpers pin observable behavior so engine rewrites keep the same external result.
 */
...
/**
 * @brief Evaluate all of matching.
 * @details Test helpers pin observable behavior so engine rewrites keep the same external result.
 */
